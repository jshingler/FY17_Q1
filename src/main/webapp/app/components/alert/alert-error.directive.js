(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('fy17Q1App.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-fy17Q1App-error');
                var entityKey = httpResponse.headers('X-fy17Q1App-params');
                if (errorHeader) {
