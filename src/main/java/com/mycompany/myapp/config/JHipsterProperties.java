...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "FY17_Q1@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "FY17_Q1 API";

        private String description = "FY17_Q1 API documentation";
